...
/*
  std::cout << "#######################\n";
  std::cout << "# first_fit_optimized #\n";
  std::cout << "#######################\n";

  //std::cout << "----Assignments: ";
  //printIntVector(assignment6);
  std::cout << "----Number of Bins: " << free_space6.size() << std::endl;
  std::cout << "----Waste: ";
  std::cout << calculateWaste(free_space6, items6) << std::endl;
*/
  //---------------------------------------------------------------------------------------
...
/*
  std::cout << "######################\n";
  std::cout << "# best_fit_optimized #\n";
  std::cout << "######################\n";

  std::cout << "----Assignments: ";
  printIntVector(assignment7);
  std::cout << "----Number of Bins: " << free_space7.size() << std::endl;
  std::cout << "----Waste: ";
  std::cout << calculateWaste(free_space7, items7) << std::endl;
*/
  //---------------------------------------------------------------------------------------
...
/*
  std::cout << "##################################\n";
  std::cout << "# first_fit_decreasing_optimized #\n";
  std::cout << "##################################\n";

  //std::cout << "----Assignments: ";
  //printIntVector(assignment8);
  std::cout << "----Number of Bins: " << free_space8.size() << std::endl;
  std::cout << "----Waste: ";
  std::cout << calculateWaste(free_space8, items8) << std::endl;
*/
  //---------------------------------------------------------------------------------------
...
/*
  std::cout << "#################################\n";
  std::cout << "# best_fit_decreasing_optimized #\n";
  std::cout << "#################################\n";

  std::cout << "--Items being packed: ";
  printDoubleVector(items9);

  std::cout << "----Bin Sizes: ";
  printDoubleVector(free_space9);

  std::cout << "----Assignments: ";
  printIntVector(assignment9);
  std::cout << "----Number of Bins: " << free_space9.size() << std::endl;
  std::cout << "----Waste: ";
  std::cout << calculateWaste(free_space9, items9) << std::endl;
*/
  //---------------------------------------------------------------------------------------
